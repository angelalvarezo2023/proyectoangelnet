  ...
  mostrar(licenseInfo) {
    ...
    modal.innerHTML = `
      <style>
        ...
        .mb-sec{background:rgba(255,255,255,0.1);padding:15px;border-radius:12px;margin-bottom:12px;}
        .mb-sec h3{color:white;font-size:14px;margin:0 0 12px;}
        .mb-row{display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;}
        .mb-row:last-child{margin-bottom:0;}
        .mb-lbl{color:rgba(255,255,255,0.9);font-size:13px;}
      </style>
      ...
      <div style="background:linear-gradient(135deg,#667eea,#764ba2);
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
          <h2 style="color:white;font-size:20px;margin:0;">⚙️ Configuración</h2>
        ...
        <button id="mb-cfg-reset"
          style="width:100%;padding:10px;background:rgba(255,255,255,0.1);
                 color:rgba(255,255,255,0.6);border:none;border-radius:8px;
...
function crearPanel(licenseInfo) {
  ...
  panel.innerHTML = `
    <div id="mb-header"
      style="background:rgba(255,255,255,0.1);padding:12px 14px;
             border-radius:14px 14px 0 0;display:flex;
             justify-content:space-between;align-items:center;user-select:none;">
      <div style="display:flex;align-items:center;gap:8px;">
        <span style="opacity:0.6;">⋮⋮</span>
        <div>
          <h2 style="margin:0;font-size:17px;">🚀 MegaBot ${badge}</h2>
          <p style="margin:2px 0 0;font-size:10px;opacity:0.7;">
      ...
      <button id="mb-btn-toggle"
        style="background:rgba(255,255,255,0.2);border:none;color:white;
               font-size:17px;width:30px;height:30px;border-radius:7px;cursor:pointer;">
        ${isMin?'▲':'▼'}
      </button>
    </div>
    ...
    <div id="mb-body" style="padding:14px;display:${isMin?'none':'block'};">
      ...
      <button id="mb-btn-cfg"
        style="width:100%;padding:10px;background:rgba(255,255,255,0.15);
               ...
               cursor:pointer;font-size:12px;font-weight:bold;margin-bottom:10px;">
        ⚙️ Configuración
      </button>
