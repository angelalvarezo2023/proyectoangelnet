...
<div id="ar-mbox" style="background:linear-gradient(160deg,#1c0a30,#0f0520);border:1px solid rgba(245,158,11,.35);border-radius:28px;padding:32px 26px;max-width:340px;width:100%;text-align:center;box-shadow:0 40px 100px rgba(0,0,0,.95);font-family:-apple-system,sans-serif;color:#fff;position:relative;z-index:2147483649">
  ...
  <p style="font-size:14px;color:rgba(255,255,255,.55);line-height:1.7;margin-bottom:22px">${warnDays === 0
