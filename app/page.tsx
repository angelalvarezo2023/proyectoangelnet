...
// ============================================================
// ESTILOS DEL LOGIN VICE CITY — TODOS los elementos del render
// posicionados sobre el fondo (vice-bg.png / vice-bg-mobile.png)
// ============================================================
const VICE_CITY_STYLES = `
/* Wrapper de toda la pantalla del login */
.vc-page-search {
  position: relative;
  min-height: 100vh;
  width: 100%;
...
.vc-megapersonals-sign {
  ...
  display: block;
  margin-bottom: 24px;
  filter: drop-shadow(0 4px 12px rgba(255, 61, 138, 0.3));
}
...
.vc-card {
  ...
  border: 1px solid rgba(255, 61, 138, 0.13);
  border-radius: 28px;
...
.vc-logo {
  ...
  height: auto;
  margin: 0 auto 34px;
  filter: drop-shadow(0 4px 14px rgba(255, 61, 138, 0.22));
}
...
.vc-feature-icon {
  ...
  color: #ff3d8a;
  flex-shrink: 0;
  filter: drop-shadow(0 0 8px rgba(255, 61, 138, 0.5));
}

.vc-feature-text { display: flex; flex-direction: column; gap: 2px; }
...
/* Pantallas medianas: ajustar lateral */
@media (max-width: 1200px) {
  .vc-left-side { width: 28%; top: 10%; }
  .vc-features { gap: 40px; }
  .vc-feature-desc { max-width: 150px; font-size: 11px; }
}

/* Tablet: ocultar elementos laterales */
@media (max-width: 1024px) {
  .vc-left-side, .vc-right-side { display: none; }
  .vc-wrap { padding: 30px 20px 200px; }
  .vc-features {
    bottom: 90px;
    flex-wrap: wrap;
    gap: 24px;
  ...
  .vc-feature-desc { max-width: 140px; font-size: 11px; }
}

/* Mobile: ocultar features y simplificar */
@media (max-width: 768px) {
  .vc-features { display: none; }
  .vc-wrap { padding: 20px 16px 70px; }
  .vc-card {
    padding: 40px 28px 32px;
    border-radius: 24px;
  }
  .vc-logo { max-width: 290px; margin-bottom: 28px; }
  ...
  .vc-footer { font-size: 11px; bottom: 14px; }
  .vc-footer-los-santos { font-size: 13px; }
}
`;
    ...
    <>
      ...
      <div className="page">
        <div className="content">
          {/* ===== LOGIN VICE CITY — REPLICA DEL RENDER ===== */}
          {step === "search" && (
            <>
              ...
              <div className="vc-page-search">
                ...
                <div className="vc-wrap">
                  <div className="vc-card">
                    <img src="/av-logo.png" alt="AngelVercel" className="vc-logo" />
