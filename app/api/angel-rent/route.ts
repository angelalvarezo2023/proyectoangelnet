...
async function handle(req: NextRequest, method: string): Promise<Response> {
  ...
  try {
    ...
    // ═══════════════════════════════════════════════════════════════════
    // Se eliminó la lógica de shouldUseProxy - ahora el proxy está siempre activo
    // Esto permite usar proxies residenciales para TODA la navegación, incluyendo edición
